...
//        return "money: " + (this.money + 2.50 * affordableMeals + 4.30 * heartyMeals) + ", number of sold affordable meals: " + this.affordableMeals + ", number of sold hearty meals: " + this.heartyMeals;
    }
}
